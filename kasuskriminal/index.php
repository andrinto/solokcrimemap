...
<script>
 ...
 var kecamatanColors = {
  "Lubuk Sikarah": "rgb(0, 13, 43)",
  "Tanjung Harapan": "rgba(130,233,209,1.0)",
  "Junjung Sirih": "rgba(46,187,230,1.0)",
  "X Koto Singkarak": "rgba(132,116,220,1.0)",
  "X Koto Diatas": "rgb(160, 20, 150)",
  "Bukit Sundi": "rgb(128, 0, 41)",
  "IX Koto Sei Lasi": "rgb(0, 67, 136)"
 };
 var clusterColor = {
 ...
 var mapHeat = L.heatLayer([],{radius:25});
 var solok = L.geoJson(null, {
   ...
   onEachFeature: function (feature, layer) {
    ...
    feature.properties.jumlah_kriminal = jumlah_kriminal[feature.properties.id];
    layer.on({
     click: function(e) {
      $("#kecamatan_title").text("Kecamatan "+feature.properties.kecamatan);
 ...
 var markerKriminal = L.geoJson(null, {
  ...
  onEachFeature: function (feature, layer) {
   ...
   mapHeat.addLatLng([feature.geometry.coordinates[1],feature.geometry.coordinates[0],20]);
 ...
 var map = L.map("map", {
   ...
   layers: [osm, solok, markerClusters, mapHeat],
   zoomControl: false,
  ...
  var overLayers = {
    ...
    "Area Kecamatan": solok,
    "Heatmap Titik Kriminal": mapHeat,
  }
